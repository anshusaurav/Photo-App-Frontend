      ...
      <ul>
        <li>
          <NavLink to='/' exact={true} activeClassName='active-nav-link'>
            <i aria-hidden='true' className='home large icon' />
          </NavLink>
        </li>
        <li>
        ...
        <li>
          <NavLink to='/upload' activeClassName='active-nav-link'>
            <i aria-hidden='true' className='camera retro large icon' />
          </NavLink>
        </li>
        <li>
          <NavLink to='/user' activeClassName='active-nav-link'>
            <i aria-hidden='true' className='user circle outline large icon' />
          </NavLink>
        </li>
        <li>
